package com.biswamit.springboot.jpa.rest.model.o2o.uni.sharedpk.p2c;
...
@Entity
@Jacksonized
@Table(name = "oto_p2c_uni_spk_employee_table")
//@TypeDef(name = "jsonb", typeClass = JsonBinaryType.class)
//@ConverterRegistration(converter = ZdtPropertyConverter.class,autoApply = true)
@Schema(name = "O2OP2CEmployeeUniSharedPk", description = "O2OP2CEmployeeUniSharedPk Model")
public class O2OP2CEmployeeUniSharedPk {
    ...
    private O2OP2CAddressUniSharedPk o2OP2CAddressUniSharedPk;
}
