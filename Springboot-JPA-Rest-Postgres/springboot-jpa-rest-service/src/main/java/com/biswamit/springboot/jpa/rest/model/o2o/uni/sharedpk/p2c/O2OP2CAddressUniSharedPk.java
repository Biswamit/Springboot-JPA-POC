...
@Entity
@Jacksonized
@Table(name = "oto_p2c_uni_spk_address_table")
//@TypeDef(name = "jsonb", typeClass = JsonBinaryType.class)
//@ConverterRegistration(converter = ZdtPropertyConverter.class,autoApply = true)
@Schema(name = "O2OP2CAddressUniSharedPk", description = "O2OP2CAddressUniSharedPk Model")
public class O2OP2CAddressUniSharedPk {
